...
![These are my lasts! Only one needs to be taped up if they're approximately the same shape. I've augmented them with cork where my feet are wider and rasped and sanded them down where my feet are smaller.](lasts.png){fig-align="center"}


![One last covered in masking tape. I've marked a line down the centre of the foot (and out of view, another black line marks the centre of the heel).](last-inside.png){fig-align="center"}
...
![The tape has been peeled off of the last and stuck down onto card. The VP ("vamp point") and CP ("counter point") have been marked on tthe instep and heel respectively.](inside-outside-forms.png){fig-align="center"}
...
![From the last to the mean form: a 2D representation of its shape!](mean-form.png){fig-align="center"}
...
![The standard form is like the first mock-up of the shoe pattern. It's the basis for making all the individual pattern pieces.](standard-form.png){fig-align="center"}
...
![The four pattern pieces for my derby boots: heel counter with back strap (top left), toe cap (top right), quarters (bottom right), and vamp (bottom left).](patt-pcs.png){fig-align="center"}
