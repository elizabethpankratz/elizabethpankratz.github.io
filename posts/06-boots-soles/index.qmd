...
We're so close: only a couple more layers to go onto the bottom of the shoe.
...
I like leaving the veg tan undyed, because it ages and takes colour so beautifully through wear, but I did sand it down and then burnish it for some light protection using Tokonole.
...
![This water-based glue is fine to hold things in place temporarily, but it's definitely not strong enough on its own to attach the outsoles permanently.](IMG_6304.png){group="gallery"}
