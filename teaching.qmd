...
### Narrative design for academic writing

CLE retreat, 2022

- A two-hour session on the fundamentals of narrative structure and how using it can improve academic writing ([workshop booklet PDF](docs/cle-narr-booklet.pdf))
